...
def maincalc():
    ...
    if inpute == "Update Log":
        ...
        print("1.2: Major Update, Added 3 new operations for Calculations, Modulus, Exponentiation and Floor division.")
        print("Planed:")
        print("    Extras: Support for more than two number, GUI, Put the calculations into a Function of it's own for API stuff")
        maincalc()
    elif inpute == "Exit":
        print("Shutting down...")
        time.sleep(1)
        ...
        print("Operations: Addition, Subtraction, Multiplication, Division, Modulus, Exponentiation, Floor division.")
        ...
        if inpute == "Addition" and num1 != 0 and num2 != 0:
            ...
            print(num1 / num2)
            maincalc()
        elif inpute == "Modulus" and num1 != 0 and num2 != 0:
            print(num1 % num2)
            maincalc()
        elif inpute == "Exponentiation" and num1 != 0 and num2 != 0:
            print(num1 ** num2)
            maincalc()
        elif inpute == "Floor division" and num1 != 0 and num2 != 0:
            print(num1 // num2)
            maincalc()
        ##  Error Catcher
